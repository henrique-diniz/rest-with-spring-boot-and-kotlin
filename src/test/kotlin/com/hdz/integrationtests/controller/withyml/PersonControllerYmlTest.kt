...
class PersonControllerYmlTest : AbstractIntegrationTest() {
    ...
    fun testLogin() {
        ...
        specification = RequestSpecBuilder()
            ...
            .setPort(TestConfigs.SERVER_PORT)
                .addFilter(RequestLoggingFilter(LogDetail.HEADERS))
                .addFilter(ResponseLoggingFilter(LogDetail.STATUS))
            .build()
    }
    ...
    fun testFindAll() {
        ...
        assertEquals("henrique", item1.firstName)
        assertEquals("diniz", item1.lastName)
        assertEquals("Osasco", item1.address)
        assertEquals("homi", item1.gender)
        ...
        assertEquals("joselito", item2.firstName)
        assertEquals("castinha", item2.lastName)
        assertEquals("rio de janeiro", item2.address)
        assertEquals("homi", item2.gender)
