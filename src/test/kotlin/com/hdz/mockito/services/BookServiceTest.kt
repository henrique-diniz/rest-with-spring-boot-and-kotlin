package com.hdz.mockito.services
...
import com.hdz.unittests.mocks.MockBook
...
internal class BookServiceTest {
    ...
    fun create() {
        ...
        `when`(repository.save(org.mockito.ArgumentMatchers.any(Book::class.java))).thenReturn(persisted)
